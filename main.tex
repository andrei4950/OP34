...
\centering
    \begin{minipage}[c]{0.65\textwidth}
        ...
        \includegraphics[width=\linewidth]{setup photo.jpeg}
    \end{minipage}
    \begin{minipage}[c]{0.03\textwidth}
        
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
        \caption{(a) Upper figure: Diagram of the experimental setup \\ 
        (b) Lower figure: Image of the experimental setup in the parallel observation configuration, iris not included}
        \label{fig:setup both}    
    \end{minipage}
\end{figure}
\end{comment}
...
\centering
    \begin{minipage}[c]{0.6\textwidth}
        \includegraphics[width=\linewidth]{d measurement.png}
    \end{minipage}
    \begin{minipage}[c]{0.3\textwidth}
